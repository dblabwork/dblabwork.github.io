...
//  ver_video[i].touchEnded(assistir);
  ...
  projetos.touchEnded(menu_superior);
  ...
  sobre.hide();
  sobre.touchEnded(menu_superior);
...
function frame_inicial(){
  institucional.time(4.7);
}

function mostra_controle(){

institucional.showControls();

}

function hide_controle(){

institucional.hideControls();
